...
const SKILLS: SkillNode[] = [
  { name: 'Python', category: 'programming', size: 'large', description: 'Primary language for data engineering, ETL scripting, and Spark jobs' },
  { name: 'SQL', category: 'programming', size: 'large', description: 'Expert in complex query optimization, indexing, and query tuning' },
  { name: 'Scala', category: 'programming', size: 'medium', description: 'Used for Spark performance-critical applications' },
  { name: 'Spark', category: 'data', size: 'large', description: 'Distributed data processing, 30% batch job optimization achieved' },
  { name: 'Kafka', category: 'data', size: 'large', description: 'Real-time data ingestion, reduced latency from hours to seconds' },
  { name: 'Airflow', category: 'data', size: 'medium', description: 'Workflow orchestration and pipeline scheduling' },
  { name: 'dbt', category: 'data', size: 'medium', description: 'Data Build Tool for transformation automation, 95% automation rate' },
  { name: 'AWS', category: 'cloud', size: 'large', description: 'S3, Glue, Lambda, Redshift, EMR - full stack cloud data platform' },
  { name: 'Snowflake', category: 'cloud', size: 'large', description: 'Cloud data warehousing with 40% storage cost reduction' },
  { name: 'Azure', category: 'cloud', size: 'medium', description: 'Data Factory, Synapse, ADLS for enterprise data lakes' },
  { name: 'Terraform', category: 'cloud', size: 'medium', description: 'Infrastructure as Code for data pipeline environments' },
  { name: 'Docker', category: 'tools', size: 'medium', description: 'Containerized data pipeline deployments' },
  { name: 'Kubernetes', category: 'tools', size: 'small', description: 'Orchestrating containerized data workloads' },
  { name: 'PostgreSQL', category: 'programming', size: 'medium', description: 'Relational database optimization and management' },
  { name: 'MongoDB', category: 'programming', size: 'small', description: 'NoSQL document store for flexible data schemas' },
  { name: 'Tableau', category: 'analytics', size: 'medium', description: 'Dashboard automation reducing report time 83%' },
  { name: 'Power BI', category: 'analytics', size: 'small', description: 'Business intelligence and interactive reporting' },
  { name: 'Hadoop', category: 'data', size: 'medium', description: 'HDFS and Hive for large-scale batch processing' },
  { name: 'CI/CD', category: 'tools', size: 'small', description: 'Automated pipeline deployment, 70% error reduction' },
  { name: 'GDPR', category: 'tools', size: 'small', description: 'Data governance and compliance protocols' },
];
